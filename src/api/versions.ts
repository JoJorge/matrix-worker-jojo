...
// GET /.well-known/openid-configuration - intentionally disabled
// Returning 404 so Element Web falls back to m.login.password instead of
// attempting OIDC-native authentication (which requires a complete JWT/JWKS implementation).
